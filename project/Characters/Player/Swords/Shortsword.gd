...
const NORMAL_PATH := "res://Characters/Player/Swords/shortsword.png"
const IRON_PATH := "res://Characters/Player/Swords/iron_shortsword.png"
const GOLD_PATH := "res://Characters/Player/Swords/golden_shortsword.png"
